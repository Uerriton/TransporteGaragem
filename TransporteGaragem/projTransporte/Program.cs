    ...
    class Program
    {
        ...
        static void construaOMenu()
        {
            ...
            do
            {
                ...
                Console.SetCursorPosition(10, 05); println("                                     ");
                ...
                Console.SetCursorPosition(10, 10); println("| 5. Liberar viagem                  |");
                Console.SetCursorPosition(10, 11); println("| 6. Listar veículos                 |");
                Console.SetCursorPosition(10, 12); println("| 7. Informar qtde de viagens        |");
                Console.SetCursorPosition(10, 13); println("| 8. Listar viagens efetuadas        |");
                Console.SetCursorPosition(10, 14); println("| 9. Informar qtd de passageiros     |");
